...
public class MailService {
	...
	/*@Autowired
	@Qualifier(value="alertMailMessage")
	//private SimpleMailMessage mailMessage;
*/	
	public void sendMail(final String from, final String to, final String subject, final Map<String, String> model, final String tempPath){
		...
		try {
			...
			MimeMessagePreparator preparator = new MimeMessagePreparator() {
				public void prepare(MimeMessage mimeMessage) throws Exception {
					...
					FileSystemResource file = new FileSystemResource(tempPath);
					message.addAttachment(file.getFilename(), file);
					
					String vmFileName = "resultsVMFile.vm";
